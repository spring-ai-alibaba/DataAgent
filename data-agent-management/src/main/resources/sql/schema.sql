...
CREATE TABLE IF NOT EXISTS memory_outbox (
  ...
  payload MEDIUMTEXT,
  status VARCHAR(16) NOT NULL DEFAULT 'PENDING' COMMENT 'PENDING/PROCESSING/DONE/FAILED/DEAD',
  attempt_count INT NOT NULL DEFAULT 0,
  lease_token VARCHAR(36) COMMENT '当前投影工作者的唯一租约',
