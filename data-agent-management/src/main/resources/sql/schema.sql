...
CREATE TABLE IF NOT EXISTS `semantic_table` (
  ...
  `table_name` varchar(255) COLLATE utf8mb4_bin NOT NULL COMMENT '物理表名',
  `business_name` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '业务名称/别名',
  `synonyms` text COLLATE utf8mb4_bin COMMENT '同义词',
  `business_description` text COLLATE utf8mb4_bin COMMENT '业务描述',
  `table_comment` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '物理表注释快照',
  `is_visible` tinyint(4) NOT NULL DEFAULT '1' COMMENT '0 不可见 1 可见',
  `status` tinyint(4) NOT NULL DEFAULT '1' COMMENT '0 停用 1 启用',
  `created_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `uk_semantic_table_agent_datasource_table` (`agent_id`, `datasource_id`, `table_name`) USING BTREE,
  KEY `idx_semantic_table_agent_id` (`agent_id`) USING BTREE,
  KEY `idx_semantic_table_datasource_id` (`datasource_id`) USING BTREE,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='结构化表语义层';
...
CREATE TABLE IF NOT EXISTS `semantic_column` (
  ...
  `datasource_id` int(11) NOT NULL COMMENT '关联的数据源ID',
  `table_name` varchar(255) COLLATE utf8mb4_bin NOT NULL COMMENT '物理表名',
  `column_name` varchar(255) COLLATE utf8mb4_bin NOT NULL COMMENT '物理字段名',
  `business_name` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '业务名称/别名',
  `synonyms` text COLLATE utf8mb4_bin COMMENT '同义词',
  `business_description` text COLLATE utf8mb4_bin COMMENT '业务描述',
  `column_comment` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '物理字段注释快照',
  `data_type` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '物理数据类型快照',
  `is_visible` tinyint(4) NOT NULL DEFAULT '1' COMMENT '0 不可见 1 可见',
  `status` tinyint(4) NOT NULL DEFAULT '1' COMMENT '0 停用 1 启用',
  `created_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `uk_semantic_column_agent_ds_table_col` (`agent_id`, `datasource_id`, `table_name`, `column_name`) USING BTREE,
  KEY `idx_semantic_column_agent_id` (`agent_id`) USING BTREE,
  KEY `idx_semantic_column_datasource_id` (`datasource_id`) USING BTREE,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='结构化列语义层';

CREATE TABLE IF NOT EXISTS `semantic_relation` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `agent_id` int(11) NOT NULL COMMENT '关联的智能体ID',
  `datasource_id` int(11) NOT NULL COMMENT '关联的数据源ID',
  `source_table_name` varchar(255) COLLATE utf8mb4_bin NOT NULL COMMENT '源表名',
  `source_column_names` varchar(512) COLLATE utf8mb4_bin NOT NULL COMMENT '源字段列表，逗号分隔',
  `target_table_name` varchar(255) COLLATE utf8mb4_bin NOT NULL COMMENT '目标表名',
  `target_column_names` varchar(512) COLLATE utf8mb4_bin NOT NULL COMMENT '目标字段列表，逗号分隔',
  `relation_type` varchar(64) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '关系类型',
  `description` varchar(1000) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '业务描述',
  `status` tinyint(4) NOT NULL DEFAULT '1' COMMENT '0 停用 1 启用',
  `created_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `idx_semantic_relation_agent_id` (`agent_id`) USING BTREE,
  KEY `idx_semantic_relation_datasource_id` (`datasource_id`) USING BTREE,
  KEY `idx_semantic_relation_source_table` (`datasource_id`, `source_table_name`) USING BTREE,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC COMMENT='结构化关系语义层';
