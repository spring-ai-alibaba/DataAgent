...
public class AgentKnowledgeConverter {
	...
	public AgentKnowledge toEntityForCreate(CreateKnowledgeDTO createKnowledgeDto, FileStorageVo fileStorageVo) {
		// 创建AgentKnowledge对象
		...
		// 如果是文档类型，设置文件相关信息
		if (fileStorageVo != null) {
			knowledge.setFileId(fileStorageVo.getId());
		}
