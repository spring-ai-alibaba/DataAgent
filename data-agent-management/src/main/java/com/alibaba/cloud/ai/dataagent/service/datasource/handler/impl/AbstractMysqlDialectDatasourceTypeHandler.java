...
public abstract class AbstractMysqlDialectDatasourceTypeHandler implements DatasourceTypeHandler {
	...
	public String buildConnectionUrl(Datasource datasource) {
		...
		return String.format("jdbc:mysql://%s:%d/%s?useSSL=false&serverTimezone=Asia/Shanghai&allowMultiQueries=true",
