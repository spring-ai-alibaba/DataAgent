...
public class MappersTest {
  ...
  @Autowired private AgentKnowledgeMapper agentKnowledgeMapper;

  @Autowired private AgentPresetQuestionMapper agentPresetQuestionMapper;

  @Autowired private ChatSessionMapper chatSessionMapper;

  @Autowired private ChatMessageMapper chatMessageMapper;

  @Autowired private SemanticModelMapper semanticModelMapper;

  @Autowired private BusinessKnowledgeMapper businessKnowledgeMapper;
  ...
  public void testChatSessionAndMessageCrud() {
    ...
    // insert session
    ChatSession session =
        new ChatSession(sessionId, agentId.intValue(), "tc_session", "active", 1L);
