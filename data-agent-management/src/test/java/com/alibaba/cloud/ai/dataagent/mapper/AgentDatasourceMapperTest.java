...
public class AgentDatasourceMapperTest {
  ...
  @Autowired private AgentDatasourceMapper agentDatasourceMapper;
  ...
  public void testAgentDatasourceUpdateRelation() {
    ...
    AgentDatasource disabledRelation =
        agentDatasourceMapper.selectByAgentIdAndDatasourceId(agentId, datasourceId);
    ...
    AgentDatasource enabledRelation =
        agentDatasourceMapper.selectByAgentIdAndDatasourceId(agentId, datasourceId);
  ...
  public void testAgentDatasourceDeleteAllByDatasourceId() {
    ...
    AgentDatasource relation1 =
        agentDatasourceMapper.selectByAgentIdAndDatasourceId(agentId1, datasourceId);
    AgentDatasource relation2 =
        agentDatasourceMapper.selectByAgentIdAndDatasourceId(agentId2, datasourceId);
  ...
  private Long createTestAgentAndGetId() {
    ...
    Long exists =
        jdbcTemplate.queryForObject("SELECT COUNT(1) FROM agent WHERE id = ?", Long.class, id);
